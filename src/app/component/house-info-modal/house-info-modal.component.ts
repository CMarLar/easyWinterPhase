...
export class HouseInfoModalComponent {
  ...
  constructor(){
    this.npc = [{nombre : "Carlos",estado : true,rol : "esposa"},{nombre : "Irene",estado : false, rol : "hijo"},{nombre : "Miguel",estado : true, rol : "escudero"},{nombre : "Javier",estado : true, rol : "amante"},{nombre : "Carlos",estado : true,rol : "esposa"},{nombre : "Irene",estado : false, rol : "hijo"},{nombre : "Miguel",estado : true, rol : "escudero"},{nombre : "Javier",estado : true, rol : "amante"},{nombre : "Carlos",estado : true,rol : "esposa"},{nombre : "Irene",estado : false, rol : "hijo"},{nombre : "Miguel",estado : true, rol : "escudero"},{nombre : "Javier",estado : true, rol : "amante"}];
    this.nombrePJ = "Pepe";

...
const routes: Routes = [
  ...
  {path:"header",component:WinterPhase3Component},
  {path:"changeplayer",component:WinterPhase4Component},
  {path:"changecharacter",component:WinterPhase5Component},
  {path:"houseinfomodal ",component:WinterPhase6aComponent},
  {path:"phase6b",component:WinterPhase6bComponent},
  {path:"phase7",component:WinterPhase7Component},
  {path:"phase8",component:WinterPhase8Component},
  {path:"phase9",component:WinterPhase9Component},

...
export class WinterPhase2Component {
  ...
  public currentPlayerName:string;
   ...
   constructor(public router : Router,public userService : UserService,private textosService: TextService, private jugadorService: PlayerService, public houseService: HouseService, public characterService:CharacterService, public campaignService:CampaignService, public yearService:YearService ){
